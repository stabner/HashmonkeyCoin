...
$(package)_patches += qt_touchinput_fix.patch
...
$(package)_config_opts_mingw32 += "QMAKE_CXXFLAGS = '$($(package)_cxxflags) $($(package)_cppflags) -D_WIN32_WINNT=0x0601 -DWIN32_LEAN_AND_MEAN'"
...
define $(package)_preprocess_cmds
  ...
  patch -p1 -i $($(package)_patch_dir)/qt_touchinput_fix.patch && \

...
from test_framework.test_framework import hashmonkeycoinTestFramework
...
class LLMQChainLocksTest(hashmonkeycoinTestFramework):
    def set_test_params(self):
        self.set_hashmonkeycoin_test_params(6, 5, fast_dip3_enforcement=True)

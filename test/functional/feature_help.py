...
"""Verify that starting hashmonkeycoind with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start hashmonkeycoind with -h for help text")
        ...
        self.log.info("Start hashmonkeycoind with -version for version information")
        ...
        self.log.info("Start hashmonkeycoind with -fakearg  to make sure it does not start")

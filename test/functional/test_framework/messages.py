...
# Objects that map to hashmonkeycoind objects, which can be serialized/deserialized
...
class msg_headers():
    ...
    def deserialize(self, f):
        # comment in hashmonkeycoind indicates these should be deserialized as blocks

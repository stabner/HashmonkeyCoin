Contributing to HashmonkeyCoin Core
============================

The HashmonkeyCoin Core project operates an open contributor model where anyone is
...
the pull request affects. Valid areas as:
  ...
  - *Qt* for changes to hashmonkeycoin-qt
...
[Translation Process](https://github.com/Raptor3um/hashmonkeycoin/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the HashmonkeyCoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall HashmonkeyCoin
Network Protocol consensus changes.

Whether a pull request is merged into HashmonkeyCoin Core rests with the project merge
...
Patches that change HashmonkeyCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the HashmonkeyCoin consensus, it must have been
...
The review process is normally fairly responsive on the HashmonkeyCoin Core repository, however
...
The project leader is the release manager for each HashmonkeyCoin Core release.

...
official/supported Docker Images found at https://hub.docker.com/r/hashmonkeycoin/hashmonkeycoind/
...
**NOTE: Please update the image description at https://hub.docker.com/r/hashmonkeycoin/hashmonkeycoind-develop/ when changing the above text**

...
// Copyright (c) 2020-2025 The HashmonkeyCoin developers
...
std::string LicenseInfo() {
        ...
        const std::string URL_WEBSITE = "<https://github.com/stabner/hashmonkeycoin>";
...
bool AppInitBasicSetup() {
    ...
    _CrtSetRepoHMNYode(_CRT_WARN, _CRTDBG_MODE_FILE);

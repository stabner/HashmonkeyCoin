...
static CBlock
CreateMainNetGenesisBlock(uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount &genesisReward) {
    const char *pszTimestamp = "2025 mainnet";
...
CreateTestNetGenesisBlock(uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount &genesisReward) {
    const char *pszTimestamp = "2025 testnet";
    const CScript genesisOutputScript = CScript() << ParseHex(
            "040184710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9")
                                                  << OP_CHECKSIG;
    return CreateGenesisBlock(pszTimestamp, genesisOutputScript, nTime, nNonce, nBits, nVersion, genesisReward);
...
// Devnet genesis block
static CBlock
CreateDevNetGenesisBlock(uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount &genesisReward) {
    const char *pszTimestamp = "2025 devnet";
    const CScript genesisOutputScript = CScript() << ParseHex(
            "040184710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9")
                                                  << OP_CHECKSIG;
    return CreateGenesisBlock(pszTimestamp, genesisOutputScript, nTime, nNonce, nBits, nVersion, genesisReward);
...
CreateRegTestGenesisBlock(uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount &genesisReward) {
    const char *pszTimestamp = "2025 regtest";
    const CScript genesisOutputScript = CScript() << ParseHex(
            "040184710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9")
                                                  << OP_CHECKSIG;
    return CreateGenesisBlock(pszTimestamp, genesisOutputScript, nTime, nNonce, nBits, nVersion, genesisReward);
...
public:
    CMainParams() {
        ...
        consensus.nSubsidyHalvingInterval = 210000; // HashmonkeyCoin uses Bitcoin's standard halving interval
        consensus.nSmartnodePaymentsStartBlock = INT_MAX; // HashmonkeyCoin: Smartnode payments disabled
        consensus.nSmartnodePaymentsIncreaseBlock = INT_MAX; // HashmonkeyCoin: Smartnode payments disabled
        ...
        genesis = CreateMainNetGenesisBlock(1734566400, 877, 0x20001ff0, 4, 500 * COIN);
...
public:
    CTestNetParams() {
        ...
        consensus.powLimit = uint256S(
                "00ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"); // ~uint256(0) >> 20
        consensus.nPowTargetTimespan = 24 * 60 * 60; // HashmonkeyCoin: 1 day
        consensus.nPowTargetSpacing = 60; // HashmonkeyCoin: 1 minute
        ...
        genesis = CreateTestNetGenesisBlock(1734566401, 310, 0x20001ff1, 4, 500 * COIN);
        VerifyGenesisPOW(genesis);
...
public:
    explicit CDevNetParams(const ArgsManager &args) {
        ...
        genesis = CreateDevNetGenesisBlock(1734566402, 94, 0x20001ff2, 4, 500 * COIN);
        VerifyGenesisPOW(genesis);
        consensus.hashGenesisBlock = genesis.GetHash();
...
public:
    explicit CRegTestParams(const ArgsManager &args) {
        ...
        genesis = CreateRegTestGenesisBlock(1734566403, 0, 0x207ffff0, 4, 500 * COIN);
        VerifyGenesisPOW(genesis);
        consensus.hashGenesisBlock = genesis.GetHash();
        // assert(consensus.hashGenesisBlock ==

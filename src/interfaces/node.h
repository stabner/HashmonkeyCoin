...
//! Interface for the src/evo part of a HashmonkeyCoin node (HashmonkeyCoind process).
    class EVO {
    public:
        virtual ~EVO() {}
...
//! Interface for the src/llmq part of a HashmonkeyCoin node (HashmonkeyCoind process).
    class LLMQ {
    public:
        virtual ~LLMQ() {}
...
//! Interface for the src/smartnode part of a HashmonkeyCoin node (HashmonkeyCoind process).
    namespace Smartnode {
        class Sync {
        public:
            virtual ~Sync() {}
...
//! Top-level interface for a HashmonkeyCoin node (HashmonkeyCoind process).
    class Node {
    public:
        virtual ~Node() {}

...
HelpMessageDialog::HelpMessageDialog(interfaces::Node &node, QWidget *parent, HelpMode helpMode) :
    ...
    if (helpMode == about) {
        ...
        QString header = "Usage: hashmonkeycoin-qt [command-line options]                     \n";
...
All the HashmonkeyCoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 HMNY, 0.01 HMNY, 0.1 HMNY, 1 HMNY and 10 HMNY -- sort of like the paper money you use every day.</li> \

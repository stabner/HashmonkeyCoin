...
//! HashmonkeyCoin Core RPC error codes
enum RPCErrorCode {
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in HashmonkeyCoind
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED = -9,  //!< HashmonkeyCoin is not connected

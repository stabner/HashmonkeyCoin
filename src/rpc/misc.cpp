...
static UniValue validateaddress(const JSONRPCRequest &request) {
    RPCHelpMan{"validateaddress",
               "\nReturn information about the given HashmonkeyCoin address.\n",
               {
                       {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The HashmonkeyCoin address to validate"},
               },
               RPCResult{
                       RPCResult::Type::OBJ, "", "",
                       {
    ...
    RPCHelpMan{"verifymessage",
               "\nVerify a signed message\n",
               {
                       {"address", RPCArg::Type::STR, RPCArg::Optional::NO,
                        "The HashmonkeyCoin address to use for the signature."},
...
UniValue getaddressutxos(const JSONRPCRequest &request) {
    RPCHelpMan{
            ...
            "\nReturns all unspent outputs for an address (requires addressindex to be enabled).\n",
            {
                ...
                {"asset", RPCArg::Type::STR, /* default */ "HMNY", "Get UTXOs for a particular asset instead of HMNY ('*' for all assets).",}
            },
            {
                RPCResult{"For HMNY",
                    RPCResult::Type::ARR, "", "",
...
UniValue getaddressdeltas(const JSONRPCRequest &request) {
    RPCHelpMan{"getaddressdeltas",
               "\nReturns all changes for an address (requires addressindex to be enabled).\n",
               {
                    ...
                    {"asset", RPCArg::Type::STR, /* default */ "HMNY", "Get all changes for a particular asset instead of HMNY.",}
...
static UniValue getaddressbalance(const JSONRPCRequest &request) {
    RPCHelpMan{"getaddressbalance",
               "\nReturns the balance for an address(es) (requires addressindex to be enabled).\n",
        {
            ...
            {"asset", RPCArg::Type::STR, /* default */ "HMNY", "Get balance for a particular asset instead of HMNY. (\"*\" for all assets)"},
        },
        {
            RPCResult{"For HMNY",
                RPCResult::Type::OBJ, "", "",
...
UniValue logging(const JSONRPCRequest &request) {
    RPCHelpMan{"logging",
               ...
               "The valid logging categories are: " + LogInstance().LogCategoriesString() + "\n"
                                                                                            ...
                                                                                            "  - \"HashmonkeyCoin\" activates all HashmonkeyCoin-specific categories at once.\n"
...
static const CRPCCommand commands[] =
        { //  category              name                      actor (function)         argNames
                ...
                {"HashmonkeyCoin",    "mnsync",                 &mnsync,                 {}},
                {"HashmonkeyCoin",    "spork",                  &spork,                  {"arg0",       "value"}},

...
This document provides guidelines for internationalization of the HashmonkeyCoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `hashmonkeycoin_en.ts` remains unchanged.

...
This mechanism has been integrated into Bitcore-Node-HashmonkeyCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/raptor3um/insight-api-hashmonkeycoin#web-socket-api](https://github.com/raptor3um/insight-api-hashmonkeycoin#web-socket-api)
* API: [https://github.com/raptor3um/insight-api-hashmonkeycoin#instantsend-transactions](https://github.com/raptor3um/insight-api-hashmonkeycoin#instantsend-transactions)

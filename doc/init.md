...
Configuration file:  `/etc/raptoreumcore/hashmonkeycoin.conf`  
...
raptoreumcore user and group.  Access to hashmonkeycoin-cli and other hashmonkeycoind rpc clients
can then be controlled by group membership.

### Mac OS X

Binary:              `/usr/local/bin/hashmonkeycoind`  
Configuration file:  `~/Library/Application Support/RaptoreumCore/hashmonkeycoin.conf`  
...
Copy org.raptoreum.hashmonkeycoind.plist into ~/Library/LaunchAgents. Load the launch agent by
running `launchctl load ~/Library/LaunchAgents/org.raptoreum.hashmonkeycoind.plist`.
...
You will need to modify org.raptoreum.hashmonkeycoind.plist if you intend to use it as a

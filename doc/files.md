...
* hashmonkeycoin.conf: contains configuration settings for hashmonkeycoind or hashmonkeycoin-qt
* hashmonkeycoind.pid: stores the process id of hashmonkeycoind while running
* database/*: BDB database environment; only used for wallet
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by hashmonkeycoind or hashmonkeycoin-qt
